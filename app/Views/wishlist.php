            ...
            <?php 
                ...
                foreach ($videoInfos as $videoInfo_temp){
                    ...
                    if($videoInfo['description']){
                        echo ('<p>'.$videoInfo['description'].'</p>');
                    } else{
                        echo ("<p>no description</p>");
                    }
                    echo form_open_multipart(base_url() . 'wishlist/delete_wishlist');
                    echo("<input type='hidden' name='video_id' value=$videoInfo[$video_id]><input type='submit' name='delete' value='Delete'>");
                    }
                    echo form_close();
                    echo ("</div><br><br>");
                }}
